***To the marker of this milestone: This folder contains the development version
   of the program, with full source code available for inspection. The release
   folder contains the bare minimum files needed to run the program, and may be
   preferable for testing. To test this development folder, you will need either
   Ant or Eclipse (Eclipse being better tested).
...
NOTES:
	- Eclipse has been configured to use the modified Java code style. Changes to
