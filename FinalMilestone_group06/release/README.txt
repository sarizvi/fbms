...
RUNNING THE PROGRAM (pre-built distribution only):
  - Windows users can run the "run.cmd" file (by double clicking the file in 
    Explorer)
...
*** For the marker of this milestone, we've included the code and everything
    needed to compile in the "development" folder.
  ...
  - The "coding.txt" file in the SVN (located in "development") contains details
